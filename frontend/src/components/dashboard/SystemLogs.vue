    ...
    <div v-else class="flex-1 overflow-hidden relative">
      ...
      >
        <div
          ...
          key="details"
          class="fixed inset-y-0 right-0 z-50 w-full sm:w-1/2 sm:max-w-xl bg-white shadow-xl border-l border-gray-200 flex flex-col"
        >
          ...
          <div class="sticky bottom-0 p-4 border-t bg-gray-50 flex justify-end">
            <button
              @click="closeDetails"
              class="px-4 py-2 text-sm font-medium text-white bg-red-500 rounded-md hover:bg-red-600 transition-colors"
            >
