      ...
      <nav class="p-4 space-y-1">
        ...
        <div>
          <button
            ...
            :class="isActiveDashboard ? 'bg-gray-800 text-white' : ''"
          >
          ...
          <div
            ...
            :class="activeMenu === 'dashboard' ? 'max-h-60 opacity-100 mt-1' : 'max-h-0 opacity-0'"
          >
            <div class="ml-9 space-y-1">
              <router-link
                to="/dashboard"
                class="block py-2 px-3 rounded-lg hover:bg-gray-800 text-sm transition-colors duration-150"
                :class="route.path === '/dashboard' ? 'bg-gray-800 text-white font-medium' : ''"
              ...
              <router-link
                ...
                class="block py-2 px-3 rounded-lg hover:bg-gray-800 text-sm transition-colors duration-150"
                :class="
                  route.path === '/dashboard/statistics' ? 'bg-gray-800 text-white font-medium' : ''
                "
                @click="isMobile && $emit('close-sidebar')"
              >
              ...
              <router-link
                ...
                class="block py-2 px-3 rounded-lg hover:bg-gray-800 text-sm transition-colors duration-150"
                :class="
                  route.path === '/dashboard/health' ? 'bg-gray-800 text-white font-medium' : ''
                "
                @click="isMobile && $emit('close-sidebar')"
              >
                System Health
        ...
        <div>
          ...
          >
            <div class="ml-9 space-y-1">
              ...
              <router-link
                to="/dashboard/users/blocked"
                class="block py-2 px-3 rounded-lg hover:bg-gray-800 text-sm transition-colors duration-150"
                :class="
                  route.path === '/dashboard/users/blocked'
                    ? 'bg-gray-800 text-white font-medium'
                    : ''
                "
                @click="isMobile && $emit('close-sidebar')"
              ...
              <router-link
                ...
                class="block py-2 px-3 rounded-lg hover:bg-gray-800 text-sm transition-colors duration-150"
                :class="
                  route.path === '/dashboard/users/groups'
                    ? 'bg-gray-800 text-white font-medium'
                    : ''
                "
                @click="isMobile && $emit('close-sidebar')"
