<template>
  <DataViewContainer
    title="Latency & Ping Tests"
    subtitle="Run real-time latency and ping diagnostics on network nodes"
    color-theme="emerald"
    :show-search="false"
    :show-add="false"
    :show-refresh="false"
  >
    ...
    <div class="flex flex-col items-center justify-center h-full min-h-[300px] gap-4 text-slate-400 dark:text-slate-500">
      ...
      <div class="text-center">
        ...
        <p class="text-sm mt-1">Latency & Ping Tests is under development</p>
      </div>
    </div>
  </DataViewContainer>
</template>
