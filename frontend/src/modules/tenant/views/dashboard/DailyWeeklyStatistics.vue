<template>
  <DataViewContainer
    title="Daily & Weekly Statistics"
    subtitle="View detailed daily and weekly network usage statistics"
    color-theme="emerald"
    :show-search="false"
    :show-add="false"
    :show-refresh="false"
  >
    ...
    <div class="flex flex-col items-center justify-center h-full min-h-[300px] gap-4 text-slate-400 dark:text-slate-500">
      ...
      <div class="text-center">
        ...
        <p class="text-sm mt-1">Daily & Weekly Statistics is under development</p>
      </div>
    </div>
  </DataViewContainer>
</template>
