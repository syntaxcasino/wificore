...
1. **`TenantVpnTunnelService`** - Manages tenant VPN tunnels
   ...
   - allocatePort()                       // Allocate 51830, 51821, etc.
...
services:
  wireguard:
    ...
    ports:
      - "51830-51920:51830-51920/udp"  # 100 tenants
    volumes:
...
- **Tenants supported**: 100+ (ports 51830-51920)
