...
├─ WireGuard IP: 10.8.0.1/24
├─ RADIUS Server: 10.8.0.1:1812
...
# Add IP address
/ip/address
add address=10.8.0.2/32 interface=wg-radius
...
/ip/route
add dst-address=10.8.0.1/32 gateway=wg-radius
...
Schema::create('router_vpn_configs', function (Blueprint $table) {
    ...
    $table->ipAddress('radius_server_ip')->default('10.8.0.1');
