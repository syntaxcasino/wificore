...
CREATE TABLE tenant_vpn_tunnels (
    ...
    listen_port INT NOT NULL, -- 51830, 51821, etc.
...
Schema::create('tenant_vpn_tunnels', function (Blueprint $table) {
    ...
    $table->integer('listen_port'); // 51830, 51821
...
class TenantVpnTunnelService
{
    ...
    protected function createTenantTunnel(string $tenantId): TenantVpnTunnel
    {
        ...
        // 4. Allocate port (51830, 51821, etc.)
...
services:
  wireguard:
    ...
    ports:
      - "51830-51830:51830-51830/udp"  # Support 10 tenants
    sysctls:
...
- **One port** (51830 + tenant_index)

### **System-Wide**:
- **Support 1000+ tenants** (ports 51830-52820)
